<aside
class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark gradient-45deg-yellow-red sidenav-gradient sidenav-active-rounded">
<div class="brand-sidebar">
    <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="<?php echo e(url('/home')); ?>"><img
                class="hide-on-med-and-down " src="<?php echo e(asset('app-assets/images/logo/materialize-logo.p')); ?>ng"
                alt="materialize logo" /><img class="show-on-medium-and-down hide-on-med-and-up"
                src="<?php echo e(asset('app-assets/images/logo/materialize-logo-color.png')); ?>"
                alt="materialize logo" /><span class="logo-text hide-on-med-and-down">OFAD</span></a><a
            class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a></h1>
</div>
<ul class="sidenav sidenav-collapsible leftside-navigation collapsible gradient-45deg-yellow-red sidenav-fixed menu-shadow"
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('storekeeper')): ?>
        <li class="bold"><a class="collapsible-header waves-effect waves-cyan "
                href="JavaScript:void(0)"><i class="material-icons">event_available</i><span
                    class="menu-title" data-i18n="Menu levels">Store keeper</span></a>
            <div class="collapsible-body">
                <ul class="collapsible collapsible-sub" data-collapsible="accordion">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_substore_sales')): ?>
        <li class="bold"><a class="collapsible-header waves-effect waves-cyan "
            ...
            <div class="collapsible-body">
                <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                    <li><a href="<?php echo e(url('/stations/view')); ?>"><i
                                class="material-icons">radio_button_unchecked</i><span
                                data-i18n="Second level">View Stations</span></a>
                    </li>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('post_substore_sales')): ?>
                        <li><a href="<?php echo e(url('/substore/days-transactions/submit')); ?>"><i
                                    class="material-icons">radio_button_unchecked</i><span
                                    data-i18n="Second level">Post Sales</span></a>
                        </li>
                    <?php endif; ?>
                    <li><a href="<?php echo e(url('/substore/days-transactions/view')); ?>"><i
                                class="material-icons">radio_button_unchecked</i><span
                                data-i18n="Second level">View /Confirm Sales</span></a>
                    </li>
                    <li><a href="<?php echo e(url('/substore/lodgement')); ?>"><i
                                class="material-icons">radio_button_unchecked</i><span
                ...
                <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('post_lubebay_sales')): ?>
                        <li><a href="<?php echo e(url('/lubebay/days-transactions/submit')); ?>"><i
                                    class="material-icons">radio_button_unchecked</i><span
                                    data-i18n="Second level">Lubebay Services</span></a>
                        </li>
                    <?php endif; ?>
...
<?php /**PATH D:\SB__\mofad_v2\resources\views/components/sidebar-menu.blade.php ENDPATH**/ ?>