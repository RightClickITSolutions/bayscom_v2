...
class ApprovalController extends Controller
{
    ...
    public function pro(Request $request){
        ...
        //return Auth::user()->getPermissionNames();
            if(Auth::user()->hasPermissionTo('approve_pro_'.$level)){
                ...
                if($request->get('approval')=='APPROVE')
                {
                    ...
                    {   
                        ...
                        if($level == $pro->final_approval){$approval_status="APPROVED_NOT_COLLECTED";}
            ...
            if(Auth::user()->hasPermissionTo('approve_lodgement_'.$level)){
                if($request->get('approval')=='APPROVE')
                {
                    ...
                    {   
                        ...
                        $system_account = Account::where('account_name','MOFAD_MAIN')->first();
