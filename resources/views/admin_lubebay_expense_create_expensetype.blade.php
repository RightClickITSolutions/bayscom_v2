                            ...
                            <div class="col s12 m12 l12">
                                <div id="Form-advance" class="card card card-default scrollspy">
                                    <div id="products-card" class="card-content">
                                        <h4 class="card-title">Create Lubebay Expense Type</h4>
                                        <form action="{{url('/admin/lubebay/expense/create-expensetype')}}" method="post">
                                            {{csrf_field()}}
                                            
                                            
                                            <div id="main-form" class="row">
                                                <div class="input-field col m4 s12">
                                                    <input type="text"  value="{{old('expense_type_name')}}"  name="expense_type_name" class="form-control" class="validate">
