                                ...
                                <div class="card-content">
                                    ...
                                    <div id="view-checkboxes">
                                        ...
                                        <row>
                                            ...
                                            <p><strong>State based accesses(customers etc...)</strong></p>
                                            @foreach($states_list as $state)

                                            <p class="mb-1">
                                                @if($user->canAccessState($state->id))
                                                    <label>
                                                        
                                                        <input name="states[]" value="{{$state->id}}" type="checkbox" checked="checked"/>
                                                ...
                                                @else
                                                    ...
                                                    <label>
                                                        ...
                                                        <input  name="states[]" value="{{$state->id}}"  type="checkbox"  />
                                                    <span>{{$state->name}}</span>
                                                    </label> 
                                                    |
                                                @endif
