       ...
       <div class="col s12 m12 l12">
          <div class="row">
              <div class="col s6 card edit_customer_form">
                  <h6 class="header-customer-form">Warehouse Edit Form</h6>
             @foreach ($warehouse_data as $item)
                <form action="{{url('admin/warehouse/edit/inst-edit/'.$item->id)}}" method="POST">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col m12">
                    ...
                    <div class="row">
                        <div class="col m12">
                            <div class="form-control">
                                ...
                                <input type="text" name="edit_location" id="" value="{{ $item->location }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
