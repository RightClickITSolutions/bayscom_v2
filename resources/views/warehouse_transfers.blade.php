...
@endsection()
      ...
      <!-- End Navbar -->
      @section('content')
      <form action="{{url('warehouse/stock-transfer')}}" method="POST" >
      <div class="col s12">
                <div class="container">
                    <div class="seaction">
                            ...
                            <div class="col s12 m12 l12">
                                <div id="form-with-validation" class="card card card-default scrollspy">
                                    <div class="card-content">
                                        <h4 class="card-title">Warehouse Transfer</h4>
                                        
                                          {{csrf_field()}}
                                            <div class="row">
                                                <div class="input-field col m5 s12">
                                                    <select name="origin_warehouse" class="form-control browser-default"> 
                                                ...
                                                <div class="input-field col m6 s12">
                                                    <select name="recipient_warehouse" class="form-control browser-default"> 
                                                        <option value="">Select Warehouse</option>
                                                        @foreach($warehouses as $warehouse )
                                                        <option value="{{ $warehouse->id }}">{{ucwords($warehouse->name)}}</option>
                                                        @endforeach
      ...
      <script>
          $('#add-product').on("click", function(){
            ...
            $('#main-form').clone(true).appendTo('#add-form');
