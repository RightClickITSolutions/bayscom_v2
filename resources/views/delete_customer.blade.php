       ...
       <div class="col s12 m12 l12">
          <div class="row">
              <div class="col s6 delete-confirmation">
                @foreach ($customer_delete_data as $item)
                    <h4>Are you sure you want to delete the customer <span>{{ $item->name }}</span> below???</h4>
                    <form action="{{url('/customer/delete/inst-delete/'.$item->id)}}" method="POST">
                      {{csrf_field()}}
