                ...
                <div class="container">
                  <div class="card">
                          <div class="card-content row">
                              <p class="caption mb-0">{{$substore->name}} Transactions </p>  
                                     
                                    <form action="{{url('/dashboard/substore/'.$substore->id)}}" method="post">
                                    {{csrf_field()}}
                            ...
                            <div class="col s12 m6 l6 animate fadeLeft">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        ...
                                        <p class="medium-small">{{(ucwords($substore->name))}} Months's transaction</p>
                            ...
                            <div class="col s12 m6 l6">
                                ...
                                <div class="card animate fadeRight">
                                    <div class="card-content">
                                        ...
                                        <p class="medium-small">{{(ucwords($substore->name))}} Months Lodgements</p>
