       ...
       <div class="col s12 m12 l12">
          <div class="row">
              <div class="col s6 delete-confirmation" style="padding-bottom: 20px;">
                @foreach ($pro_reverse as $item)
                    <h4>Are you sure you want to Reserve the PRO: <span>{{ $item->id }}</span> ???</h4>
                    <form action="{{url('/pro/reverse_pro/delete/inst-delete/'.$item->id)}}" method="POST">
                      {{csrf_field()}}
