                                    ...
                                    <div class="card-content invoice-print-area">
                                        ...
                                        <div class="invoice-product-details">
                                            <table class="striped responsive-table">
                                                ...
                                                <tbody>
                                                    @foreach($lst->order_snapshot() as $order_item)
                                                    <tr>
                                                        <td>{{$order_item->service_id}}</td>
                                                        <td>{{$order_item->service_name}}</td>
                                                        <td>{{number_format($order_item->service_price,2)}}</td>
                                                        <td>{{$order_item->service_quantity}}</td>
                                                        <td class="indigo-text right-align">₦{{number_format($order_item->service_quantity*$order_item->service_price,2)}}</td>
                                                    </tr>
                                                    @endforeach
                                            ...
                                            <div class="row">
                                                <div class="col m5 s12">
                                                    ...
                                                    <li class="display-flex justify-content-between">
                                                       ...
                                                       @if($lst->approval->{$lst->final_approval}!=0)
                                                               Approved By:  {{ $lst->approvedBy($lst->final_approval) }}
                                                ...
                                                <div class="col xl4 m7 s12 offset-xl3">
                                                    <ul>
                                                        <!-- <li class="display-flex justify-content-between">
                                                            ...
                                                            <h6 class="invoice-subtotal-value">{{number_format($lst->order_total,2)}}</h6>
                                                        </li>
                                                        ...
                                                        <li class="display-flex justify-content-between">
                                                            ...
                                                            <h6 class="invoice-subtotal-value">₦{{number_format($lst->total_amount,2)}}</h6>
                                                        </li>
                                                        <!-- <li class="display-flex justify-content-between">
