       ...
       <div class="col s12 m12 l12">
          <div class="row">
              <div class="col s6 delete-confirmation">
                @foreach ($user_delete_data as $item)
                    <h4>Are you sure you want to delete the users <span>{{ $item->email }}</span> below???</h4>
                    <form action="{{url('/admin/users/delete-user/inst-delete/'.$item->id)}}" method="POST">
                      {{csrf_field()}}
