                                            ...
                                            <div class="col s12">
                                                <table id="data-table-simple" class="display">
                                                    ...
                                                    @foreach($pro_list as $pro)
                                                        <tr>
                                                        <td>
                                                           <a href="{{url('/pro/view-details/'.$pro->id)}}"> {{$pro->id}} </a>
                                                        </td>
                                                        <!-- <td>
                                                           <a href="{{url('/pro/view-details/'.$pro->id)}}"> {{$pro->transaction_id}} </a>
                                                        </td> -->
                                                        ...
                                                        <td>
                                                            ...
                                                            @if($pro->approval->l1!=0)
                                                                {{$pro->approvedBy('l1')}}
                                                            
                                                            @elseif($pro->approval->l2!=0)
                                                                {{$pro->approvedBy('l2')}}
                                                            @else
                                                                @include('includes.approve_form',['action'=>'/approve-pro','process_id'=>$pro->id,'process_type'=>'PRO','level'=>'l1','button_label'=>'Check'])
                                                                <br>
                                                                @include('includes.decline_form',['action'=>'/approve-pro','process_id'=>$pro->id,'process_type'=>'PRO','level'=>'l1'])
                                                        ...
                                                        @can('approve_pro_l2')
                                                        <td>
                                                            @if($pro->approval->l2!=0)
                                                                {{$pro->approvedBy('l2')}}
                                                            
                                                            @else
                                                            @include('includes.approve_form',['action'=>'/approve-pro','process_id'=>$pro->id,'process_type'=>'PRO','level'=>'l2'])
                                                            <br>    
                                                            @include('includes.decline_form',['action'=>'/approve-pro','process_id'=>$pro->id,'process_type'=>'PRO','level'=>'l2'])
        ...
        <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> List of PROs Raised</p>
                </div>
                <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                              ...
                              @else
                                @include('includes.approve_form',['action'=>'/approve-pro','process_id'=>$pro->id,'process_type'=>'PRO','level'=>'l1'])
