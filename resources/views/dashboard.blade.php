                    ...
                    <div class="section">
                            ...
                            <div class="col s12 m6 l6 animate fadeLeft">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        ...
                                        <p class="medium-small">This Months's transaction</p>
                        ...
                        <!-- <div id="card-stats" class="pt-0">
                         ...
                         <div class="col s12 m6 l6 animate fadeLeft">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <h4 class="card-title mb-0">Total Service sale <i class="material-icons float-right">more_vert</i></h4>
                                        <p class="medium-small">This Month's transaction</p>
                                        <div class="total-transaction-container">
                            ...
                            <div class="col s12 m6 l6">
                                ...
                                <div class="card animate fadeRight">
                                    <div class="card-content">
                                        <h6 class="mb-0 mt-0 display-flex justify-content-between">Services Lodgements<i class="material-icons float-right">more_vert</i>
                                        </h6>
                                        <p class="medium-small">This Month</p>
                                        <div class="current-balance-container">
