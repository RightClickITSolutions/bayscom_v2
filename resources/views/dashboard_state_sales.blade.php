         ...
         <div class="col s12">
                ...
                <div class="card">
                          <div class="card-content row">
                              <p class="caption mb-0">{{$state->name}} Transactions </p>  
                                     
                                    <form action="{{url('/dashboard/state/'.$state->id)}}" method="post">
                                    {{csrf_field()}}
                    ...
                    <div class="section">
                            ...
                            <div class="col s12 m6 l6 animate fadeLeft">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <h4 class="card-title mb-0">{{$state->name}} <i class="material-icons float-right">more_vert</i></h4>
                        ...
                        <div class="card">
                         ...
                         <!-- Lubebay Services Current substores balance & total transactions cards-->
                        <div class="row vertical-modern-dashboard">
                            
                            <div class="col s12 m6 l6 animate fadeLeft">
                                <!-- Lubebay Services  Total Transaction -->
                                <div class="card">
                                    <div class="card-content">
                                        <h4 class="card-title mb-0">{{$state->name}} <i class="material-icons float-right">more_vert</i></h4>
                                        <p class="medium-small">Services  Sales</p>
                                        <div class="total-transaction-container">
                            ...
                            <div class="col s12 m6 l6">
                                <!-- Lubebay Services  Current Balance -->
                                <div class="card animate fadeRight">
                                    <div class="card-content">
                                        ...
                                        <h5 class="center-align">₦ <?=number_format($grand_total_lubebay_service_lodged)?></h5>
                                        <p class="medium-small center-align">Total sales</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!--/ Lubebay Services Current balance & total transactions cards-->
                        <div class="card">
                            <div class="card-content">
                                    ...
                                    <div class="col s12">
                                        <table id="scroll-dynamic" class="display scroll-dynamic">
                                          ...
                                          <tbody>
                                              ...
                                              @foreach($comipled_service_list as $service_summery)
                                              <tr>
                                              
                                                  <td>{{$service_summery['service_name']}}</td>
                                                  <td>{{number_format($service_summery['service_total_quantity'])}}</td>
                                                  <td> ₦{{number_format($service_summery['service_total_price'],2)}}</td>
                                          ...
                                          <tfoot>
                                              <tr>
                                                  <th>Total </th>
                                                  <th>{{number_format($grand_total_lubebay_service_quantity)}}</th>
                                                  <th> ₦{{number_format($grand_total_lubebay_service_price)}}</th>
                                              </tr>
                                          </tfoot>
                                      </table>
                                    </div>
...
// Donut chart
  ...
  var CurrentBalanceDonutChart = new Chartist.Pie(
    "#current-balance-donut-chart",
    {
      ...
      series: [
        ...
        { meta: "Remaining", value: (<?=($mofad_total_direct_sales-$mofad_total_direct_sales_lodgement)? ($mofad_total_direct_sales-$mofad_total_direct_sales_lodgement): 1?>) }
      ]
    },
    {
      donut: true,
      ...
      plugins: [
        ...
        Chartist.plugins.fillDonut({
          items: [
            {
              content:
              '<p  class="small text-center">Lodged</p><h5 class="mt-0 mb-0 small">₦ {{number_format($mofad_total_direct_sales_lodgement)}}</h5>'
            }
          ]
        })
      ]
  ...
  // -----------
  console.log('test test');
  var grand_total_price = <?=$grand_total_lubebay_service_price?> ;
  var grand_total_lodged = <?=$grand_total_lubebay_service_lodged?> ;
  console.log(grand_total_price);
  console.log(<?=json_encode($graph_sales_array)?>);
  ...
  var CurrentBalanceDonutChart = new Chartist.Pie(
    "#current-balance-donut-chart2",
    {
      ...
      series: [
        { meta: "Lodged", value: (grand_total_lodged) },
        { meta: "Remaining", value: (<?=($grand_total_lubebay_service_price-$grand_total_lubebay_service_lodged)? ($grand_total_lubebay_service_price-$grand_total_lubebay_service_lodged): 1?>) }
      ]
    },
    {
      donut: true,
      ...
      plugins: [
        ...
        Chartist.plugins.fillDonut({
          items: [
            {
              content:
              '<p  class="small text-center">Lodged</p><h5 class="mt-0 mb-0 small">₦ {{number_format($grand_total_lubebay_service_lodged)}}</h5>'
            }
          ]
        })
      ]
  ...
  var TotalTransactionLine = new Chartist.Line(
    ...
    {
    labels: <?=$graph_label_array?>,
      series: [<?=json_encode($graph_lubebay_service_sales_array)?>]
    },
    {
      chartPadding: 0,
      axisX: {
