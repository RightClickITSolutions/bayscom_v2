                    ...
                    <div class="section section-data-tables">
                        <div class="card">
                            <div class="card-content">
                                <p class="caption mb-0">{{$substore->name}} Sales/lodgement History</p>
                            </div>
                        </div>
                        <!-- DataTables example -->
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div id="button-trigger" class="card card card-default scrollspy">
                                    <div class="card-content">
                                        <h4 class="card-title">Product sales lodgements </h4>
                                        <div class="row">
                                            ...
                                            <div class="col s4 pull-right">
                                              <a href="{{url('/substore/lodgement/confirmation/'.$substore->id)}}" class="btn cyan waves-effect waves-light blue darken-1 right">View/Confirm lodgements Status</a>
                                            </div>
